...
{
    public class FFVideoConvert : System.Web.UI.Page
    {
        ...
        {
            string ffmpeg = Server.MapPath(FFVideoConvert.ffmpegtool);
            if ((!System.IO.File.Exists(ffmpeg)) || (!System.IO.File.Exists(fileName)))
            {
                return "";
            }
            string flv_file = System.IO.Path.ChangeExtension(playFile, ".flv");
            string FlvImgSize = FFVideoConvert.sizeOfImg;
        ...
        {
            string tool = Server.MapPath(FFVideoConvert.mencodertool);
